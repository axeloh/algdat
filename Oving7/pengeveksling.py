...
def make_memoization_table(table, coins, value):
    # Ønsker å unngå at overlappende problemer løses flere ganger
    # Benytter meg av at jeg kan bruke tidligere tabell dersom det finnes
    ...
    # Dersom value er mindre eller lik tidligere tabell, kan jeg bruke denne tabellen direkte
    t = len(table)
    if value >= t:
        inf = 1000000000
